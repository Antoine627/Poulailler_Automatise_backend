...
router.delete('/by-day', authMiddleware, historyController.getHistoryByDay);

// Route pour afficher l'historique par semaine
router.delete('/by-week', authMiddleware, historyController.getHistoryByWeek);

// Route pour afficher l'historique par semaine
router.delete('/by-month', authMiddleware, historyController.getHistoryByMonth);
